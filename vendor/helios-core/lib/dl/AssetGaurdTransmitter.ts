...
export class FullRepair extends BaseTransmitter {
    ...
    constructor(
        ...
        private syncModpackWithServer: boolean,
        private removeExcessiveMods: boolean
    ) {
        super()
    }
    ...
    public verifyFiles(onProgress: (percent: number) => void): Promise<number> {
        ...
        return new Promise<number>((resolve, reject) => {
            ...
            this.receiver.send({
                ...
                syncModpackWithServer: this.syncModpackWithServer,
                removeExcessiveMods: this.removeExcessiveMods
